<div class="form-group {{ $errors->has('partner_id') ? 'has-error' : '' }}">
	<label for="partner_id" class="col-sm-3 control-label">Participante:</label>
	<div class="col-sm-7">
        <div class="input-group">
       		...
       		@if ($form_method == "put")
			   	{!! Form::select('partner_id', $partners, $value = null, ['id'=>'partners_list', 'class'=>'form-control select2', 'disabled'=>true]) !!}
			@else
				{!! Form::select('partner_id', $partners, $value = null, ['id'=>'partners_list', 'class'=>'form-control select2']) !!}
			@endif
       	</div>
    </div>
</div>
